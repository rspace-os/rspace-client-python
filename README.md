...
| Instruments & Instrument Templates *(new in 2.7.0, beta RSpace 2.24)* | Create, update, and manage Inventory instruments and instrument templates |
...
| RSpace Inventory API | 1.73 – 1.76 inclusive ⚠️ *pre-dates the 2.7.0 Instruments feature (beta RSpace 2.24) — please confirm/update this range* |
...
See what others have built on top of RSpace — integrations, tools, and extensions — on the **[Community Projects](https://github.com/rspace-os/community/blob/main/community-projects/community-projects.md)** page. Built something with this client? Share it in an office hour or open a PR to add it.
