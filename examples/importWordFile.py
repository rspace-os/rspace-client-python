...
print("Importing an example word file in 'resources' folder : {}".format("fish_method.doc"))
with open('resources/fish_method.doc', 'rb') as f:
    rspaceDoc = client.import_word(f, folder_id)
    print('File "{}" was imported to  folder {} as {} ({})'
          .format(f.name,folder_id, rspaceDoc['name'], rspaceDoc['globalId']))
