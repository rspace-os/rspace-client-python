...
def delete_users():
    ...
    with open("toDelete-8087.txt", "r") as toDelete, open("log-delete.txt", "a+") as deletelog:
...
#Simple search
response = client.get_users(page_size=50,tempaccount_only=False, last_login_before="2016-01-01",  created_before="2016-01-01")
